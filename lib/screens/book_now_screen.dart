...
//     final jsonContent =
//         await rootBundle.loadString('assets/json/meetings/bookedMeetings.json');
//     final jsonData = json.decode(jsonContent);
//     final List<dynamic> eventsData = jsonData['events'];
//     final List<Event> events =
//         eventsData.map((eventJson) => Event.fromJson(eventJson)).toList();

//     // Update the _events map with the loaded events
...
//                                 TimeSlotViewSettings(startHour: 8, endHour: 19),
//                           ),
//                         ),
//                         actions: [
//                           // ElevatedButton(
...
//             //                     subtitle: Text(
//             //                         'Date: ${value[index].date.toString()}'), // Customize as needed
//             //                   ),
//             //                 );
//             //               });
//             //         })),
...
//                   itemBuilder: (context, index) {
//                     final data = _events!.keys.elementAt(
//                         index); // Get the date key at the specified index
//                     final eventsForDate = _events![data] ??
//                         []; // Get the list of events for the date or an empty list if it's null
...
//                           child: Text(
//                             '${data.day.toString()} ${getMonthName(data.month)}',
//                             style: TextStyle(
...
//                             children: [
//                               // Text(
//                               //     'Date: ${data.toString()}'), // Display the date
...
//                                     //   // border: Border.all(
//                                     //   //   color: Color(
//                                     //   //       0xFFFFAB00), // Specify the border color here
//                                     //   // ),
...
//                                             21), // Adjust border radius as needed
//                                       ),
...
//                                                           Text(
//                                                             'Date: ${event.date.day.toString()}.${event.date.month.toString()}.${event.date.year.toString()}',
//                                                             style: TextStyle(
//                                                               fontSize:
