...
class BlackoutDaysData {
  ...
  BlackoutDaysData.fromJson(Map<String, dynamic> json) {
    ...
    blackoutDateConferenceId = json['blackout_date_conference_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['blackout_date_conference_id'] = this.blackoutDateConferenceId;
